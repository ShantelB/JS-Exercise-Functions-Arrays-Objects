...
*/
function temperatureInF(temp1, temp2) {// temp1 represent temp and temp2 ===to f or c
  if (temp2 === 'C'){
    return temperatureCtoF(temp1) + "F";
  }
  else {return temp1 + "F"};
}
...
const healthy = [ 'orange', 'grape', 'apple', 'banana', 'mango' ];
